    ...
    private static func objectives(
        ...
        case .fortress:
            return [
                ...
                (.hiddenTesla, GridCoordinate(column: 14, row: 9)),
                (.giantBomb, GridCoordinate(column: 13, row: 8)),
                (.airBomb, GridCoordinate(column: 13, row: 6)),
                (.airSweeper, GridCoordinate(column: 13, row: 4)),
        ...
        case .corridor:
            return [
                ...
                (.hiddenTesla, GridCoordinate(column: 14, row: 2)),
                (.giantBomb, GridCoordinate(column: 13, row: 8)),
                (.airBomb, GridCoordinate(column: 13, row: 10)),
                (.airSweeper, GridCoordinate(column: 13, row: 12)),
        ...
        case .doubleCore:
            return [
                ...
                (.hiddenTesla, GridCoordinate(column: 14, row: 13)),
                (.giantBomb, GridCoordinate(column: 13, row: 8)),
                (.airBomb, GridCoordinate(column: 13, row: 11)),
                (.airSweeper, GridCoordinate(column: 13, row: 4)),
